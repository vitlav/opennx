...
#define ID_DIALOG_PROPERTIES_SYMBOL_17 _("XDM")
...
#define ID_DIALOG_PROPERTIES_SYMBOL_46 _("Cache")
#define ID_DIALOG_PROPERTIES_SYMBOL_47 _("In memory")
#define ID_DIALOG_PROPERTIES_SYMBOL_48 _("0 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_49 _("1 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_50 _("2 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_51 _("4 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_52 _("8 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_53 _("16 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_54 _("32 Mb")
...
#define ID_DIALOG_PROPERTIES_SYMBOL_58 _("256 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_59 _("512 Mb")
#define ID_DIALOG_PROPERTIES_SYMBOL_60 _("Clean all cache files")
#define ID_DIALOG_PROPERTIES_SYMBOL_61 _("Services")
#define ID_DIALOG_PROPERTIES_SYMBOL_62 _("Enable SMB sharing")
#define ID_DIALOG_PROPERTIES_SYMBOL_63 _("Default port")
#define ID_DIALOG_PROPERTIES_SYMBOL_64 _("Enable CUPS printing")
#define ID_DIALOG_PROPERTIES_SYMBOL_65 _("Add")
#define ID_DIALOG_PROPERTIES_SYMBOL_66 _("Modify")
#define ID_DIALOG_PROPERTIES_SYMBOL_67 _("Delete")
#define ID_DIALOG_PROPERTIES_SYMBOL_68 _("Enable multimedia support")
#define ID_DIALOG_PROPERTIES_SYMBOL_69 _("USB")
#define ID_DIALOG_PROPERTIES_SYMBOL_70 _("Enable USB forwarding")
#define ID_DIALOG_PROPERTIES_SYMBOL_71 _("Environment")
#define ID_DIALOG_PROPERTIES_SYMBOL_72 _("User NX directory")
#define ID_DIALOG_PROPERTIES_SYMBOL_73 _("...")
#define ID_DIALOG_PROPERTIES_SYMBOL_74 _("Remove old session files")
#define ID_DIALOG_PROPERTIES_SYMBOL_75 _("System NX directory")
#define ID_DIALOG_PROPERTIES_SYMBOL_76 _("System CUPS daemon")
#define ID_DIALOG_PROPERTIES_SYMBOL_77 _("System USBIP daemon")
#define ID_DIALOG_PROPERTIES_SYMBOL_78 _("Local command socket path")
#define ID_DIALOG_PROPERTIES_SYMBOL_79 _("Local port")
#define ID_DIALOG_PROPERTIES_SYMBOL_80 _("Create a desktop icon for this session")
#define ID_DIALOG_PROPERTIES_SYMBOL_81 _("Reset hidden messages")
#define ID_DIALOG_PROPERTIES_SYMBOL_82 _("Always use lowercase login name")
#define ID_DIALOG_PROPERTIES_SYMBOL_83 _("About")
#define ID_DIALOG_PROPERTIES_SYMBOL_84 _("&Delete")
#define ID_DIALOG_PROPERTIES_SYMBOL_85 _("&Apply")
#define ID_DIALOG_PROPERTIES_SYMBOL_86 _("&OK")
#define ID_DIALOG_PROPERTIES_SYMBOL_87 _("&Cancel")
