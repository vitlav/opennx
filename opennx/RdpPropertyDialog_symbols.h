/////////////////////////////////////////////////////////////////////////////
// Name:        RdpPropertyDialog_symbols.h
...
#define ID_DIALOG_SETTINGS_RDP_SYMBOL_1 _("Windows Terminal Server")
#define ID_DIALOG_SETTINGS_RDP_SYMBOL_2 _("Please specify the name of the Windows computer\\nconnected to the MX server")
#define ID_DIALOG_SETTINGS_RDP_SYMBOL_3 _("Authentication")
#define ID_DIALOG_SETTINGS_RDP_SYMBOL_4 _("Show the Windows logon")
#define ID_DIALOG_SETTINGS_RDP_SYMBOL_5 _("Use MX credentials")
