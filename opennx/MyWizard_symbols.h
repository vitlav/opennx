...
#define ID_WIZARD_SYMBOL_22 _("Custom")
#define ID_WIZARD_SYMBOL_23 _("Settings...")
#define ID_WIZARD_SYMBOL_24 _("Select the size of your remote desktop.")
#define ID_WIZARD_SYMBOL_25 _("640x480")
#define ID_WIZARD_SYMBOL_26 _("800x600")
#define ID_WIZARD_SYMBOL_27 _("1024x768")
#define ID_WIZARD_SYMBOL_28 _("Available Area")
#define ID_WIZARD_SYMBOL_29 _("Fullscreen")
#define ID_WIZARD_SYMBOL_30 _("W")
#define ID_WIZARD_SYMBOL_31 _("H")
#define ID_WIZARD_SYMBOL_32 _("OpenNX Client supports authentication using a variety of USB SmartCard tokens. Enable this option if you intend to use such a token.")
#define ID_WIZARD_SYMBOL_33 _("Use SmartCard")
#define ID_WIZARD_SYMBOL_34 _("Authorization credentials are always encrypted while establishing a connection. For increased security, you can enable the following option.")
#define ID_WIZARD_SYMBOL_35 _("Enable SSL encryption of all traffic")
#define ID_WIZARD_SYMBOL_36 _("Create shortcut on desktop")
#define ID_WIZARD_SYMBOL_37 _("Show the Advanced Configuration dialog")
